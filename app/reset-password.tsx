  ...
  const handleResetPassword = async () => {
    ...
    try {
      ...
      const { error } = await supabase.auth.resetPasswordForEmail(email, {
        redirectTo: 'iWetMyPlants://reset-password-callback',
      });
      ...
      Alert.alert(
        ...
        'Please check your email for the password reset link. If you don\'t receive it within a few minutes, check your spam folder.',
        [
          {
            text: 'OK',
            onPress: () => router.back(),
        ...
        <View style={styles.formContainer}>
          ...
          >
            <View style={styles.buttonContent}>
              <Ionicons name="key-outline" size={24} color={colors.card} style={styles.buttonIcon} />
